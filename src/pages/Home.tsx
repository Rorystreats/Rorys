...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Announcement Banner */}
        <Link to="/product/trust-fund-behavior" className="bg-[#6B1111] text-[#FDFBF7] py-2.5 overflow-hidden flex whitespace-nowrap block hover:bg-[#5a0f0f] transition-colors cursor-pointer">
        <motion.div 
          animate={{ x: ["0%", "-50%"] }}
